...
function FancyImg_control() 
{
	...
	{
		$FancyImg_Title = sanitize_text_field($_POST['FancyImg_Title']);
		$FancyImg_Setting = sanitize_text_field($_POST['FancyImg_Setting']);
...
function FancyImg_adminscripts() 
{
	if( !empty( $_GET['page'] ) ) 
	{
		switch ( $_GET['page'] ) 
		{
			case 'fancy-image-show':
				wp_register_script( 'fancy-adminscripts', WP_FancyImg_PLUGIN_URL . '/pages/setting.js', '', '', true );
				wp_enqueue_script( 'fancy-adminscripts' );
				$fancy_select_params = array(
					'FancyImg_Gallery'   	=> __( 'Please enter the image path.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_Width'  		=> __( 'Please enter the gallery width, only number.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_Height'   	=> __( 'Please enter the gallery height, only number.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_delay'  		=> __( 'Please enter the gallery effect delay, only number.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_StripDelay'  	=> __( 'Please enter the strip delay, only number.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_Strips'  		=> __( 'Please enter the delay, only number.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_Extra1'  		=> __( 'Please enter the image folder location.', 'fancy-select', 'fancy-image-show' ),
					'FancyImg_delete'		=> __( 'Do you want to delete this record?', 'fancy-select', 'fancy-image-show' ),
				);
				wp_localize_script( 'fancy-adminscripts', 'fancy_adminscripts', $fancy_select_params );
				break;
		}
	}
} 
...
add_action('admin_enqueue_scripts', 'FancyImg_adminscripts');

class FancyImg_Validation
{
	...
	{
		$returnvalue = "zipper";
		if($value == "zipper" || $value == "wave" || $value == "curtain" || $value == "fountain top" || $value == "random top")
		{
			$returnvalue = $value;
		}
		return $returnvalue;
