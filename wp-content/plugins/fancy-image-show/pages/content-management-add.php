...
if (isset($_POST['FancyImg_form_submit']) && $_POST['FancyImg_form_submit'] == 'yes')
{
	...
	$form['FancyImg_Gallery'] = isset($_POST['FancyImg_Gallery']) ? sanitize_text_field($_POST['FancyImg_Gallery']) : '';
	...
	$form['FancyImg_Width'] = isset($_POST['FancyImg_Width']) ? sanitize_text_field($_POST['FancyImg_Width']) : '';
	$returnvalue = FancyImg_Validation::num_val($form['FancyImg_Width']);
	if ($form['FancyImg_Width'] == '' || $returnvalue == "invalid")
	{
		$FancyImg_errors[] = __('Please enter valid width.', 'fancy-image-show');
		$FancyImg_error_found = TRUE;
	}
	
	$form['FancyImg_Height'] = isset($_POST['FancyImg_Height']) ? sanitize_text_field($_POST['FancyImg_Height']) : '';
	$returnvalue = FancyImg_Validation::num_val($form['FancyImg_Height']);
	if ($form['FancyImg_Height'] == '' || $returnvalue == "invalid")
	{
		$FancyImg_errors[] = __('Please enter valid height.', 'fancy-image-show');
		$FancyImg_error_found = TRUE;
	}
	
	$form['FancyImg_Effect'] = isset($_POST['FancyImg_Effect']) ? sanitize_text_field($_POST['FancyImg_Effect']) : '';
	$returnvalue = FancyImg_Validation::effect_val($form['FancyImg_Effect']);
	
	$form['FancyImg_delay'] = isset($_POST['FancyImg_delay']) ? sanitize_text_field($_POST['FancyImg_delay']) : '';
	if(!is_numeric($form['FancyImg_delay'])) { $form['FancyImg_delay'] = 3000; }
	
	$form['FancyImg_Strips'] = isset($_POST['FancyImg_Strips']) ? sanitize_text_field($_POST['FancyImg_Strips']) : '';
	if(!is_numeric($form['FancyImg_Strips'])) { $form['FancyImg_Strips'] = 30; }
	
	$form['FancyImg_StripDelay'] = isset($_POST['FancyImg_StripDelay']) ? sanitize_text_field($_POST['FancyImg_StripDelay']) : '';
	if(!is_numeric($form['FancyImg_StripDelay'])) { $form['FancyImg_StripDelay'] = 12; }
	
	$form['FancyImg_Random'] = isset($_POST['FancyImg_Random']) ? sanitize_text_field($_POST['FancyImg_Random']) : '';
	$returnvalue = FancyImg_Validation::val_yn($form['FancyImg_Random']);
	
	$form['FancyImg_Extra1'] = isset($_POST['FancyImg_Extra1']) ? sanitize_text_field($_POST['FancyImg_Extra1']) : '';
	if ($form['FancyImg_Extra1'] == '')
	{
		$FancyImg_errors[] = __('Please enter image folder location.', 'fancy-image-show');
		$FancyImg_error_found = TRUE;
	}
...
<div class="form-wrap">
	...
	<form name="FancyImg_form" method="post" action="#" onsubmit="return FancyImg_submit()"  >
      <h3><?php _e('Add details', 'fancy-image-show'); ?></h3>
		...
		<input name="FancyImg_Extra1" type="text" id="FancyImg_Extra1" value="<?php echo $form['FancyImg_Extra1']; ?>" size="80" maxlength="1024" />
