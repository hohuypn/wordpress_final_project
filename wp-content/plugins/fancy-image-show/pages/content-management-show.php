...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
	  ...
	  <a href="<?php echo WP_FancyImg_ADMIN_URL; ?>&amp;ac=add"><input class="button action" type="button" value="<?php _e('Add New', 'fancy-image-show'); ?>" /></a>
	  <a target="_blank" href="<?php echo WP_FancyImg_FAV; ?>"><input class="button action" type="button" value="<?php _e('Help', 'fancy-image-show'); ?>" /></a>
	  </div>
